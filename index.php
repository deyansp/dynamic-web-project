...
<body>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption">
                    ...
                    <a href="#ticket-section" class="btn btn-success btn-lg">Buy Now</a>
                </div>
            </div>
    ...
    <div class= "container-fluid" id="ticket-section">
        <div class="row">
            <div class ="col-12 content-heading">
                <h2 class = "display-4 text-center">See Kesha On Tour</h2>
                <hr class = "my-4">
            </div>
        </div>
        <div class = "container">
                ...
                <div class="col-md-4">
                    <div class="card">
                         <div class="card-body">
                            ...
                            <a class="btn btn-success" data-toggle="modal" href="#logInModal">Purchase</a>
                          </div>
