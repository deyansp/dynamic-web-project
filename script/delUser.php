...
if (isset($_GET['id'])) {
 ...
 ?>
		...
		<body>
			<div class='container'>
			<h4 class='display-4'>Delete User</h4>
            <p>Are you sure you want to permanently delete this user with ID: <?php echo $id;?>?</p>
...
if (isset($_POST['submit']) && isset($_POST['delID'])) {
			...
			if ($statement = $connection->prepare("DELETE FROM keshaUsers WHERE id=?")) {
